...
import "./scrollMonitor"; // if you're not using require, you can use the scrollMonitor global.
...
function initMorph() {
  ...
  // console.log("CONTENT EELEEMS", DOM.contentElems);
  // DOM.contentLinks = Array.from(document.querySelectorAll(".content__link"));
  // DOM.footer = document.querySelector("footer.main");
